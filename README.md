Hi ![](https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif) My name is Alessio Bragetti
=========================================================================================================================================

Computer Science Student & Aspiring Software Developer
------------------------------------------------------

Focused Computer Science student with a strong foundation in low-level programming and logic. I specialize in C and Java, with a growing interest in Web and Mobile development. I am trilingual (English, Italian, Spanish), which allows me to collaborate effectively in international environments. Currently applying academic principles to build functional, well-documented software.

*   🌍  I'm based in Italy
*   ✉️  You can contact me at [alessio.bragetti@protonmail.com](mailto:alessio.bragetti@protonmail.com)
*   🚀  I'm currently working on [A C-based command-line RPG inspired by Stranger Things.](http://https://github.com/lwsioo/StrangerThingsRPG)
